...
typedef MTK::S2<double, 98012, 10000, 1> S2;
...
Eigen::Matrix<double, 34, 1> get_f(state_ikfom &s, const input_ikfom &in)
{
	Eigen::Matrix<double, 34, 1> res = Eigen::Matrix<double, 34, 1>::Zero();
	vect3 omega;
...
Eigen::Matrix<double, 34, 33> df_dx(state_ikfom &s, const input_ikfom &in)
{
	Eigen::Matrix<double, 34, 33> cov = Eigen::Matrix<double, 34, 33>::Zero();
	cov.template block<3, 3>(0, 12) = Eigen::Matrix3d::Identity(); // dp_
	vect3 acc_;
...
Eigen::Matrix<double, 34, 12> df_dw(state_ikfom &s, const input_ikfom &in)
{
	Eigen::Matrix<double, 34, 12> cov = Eigen::Matrix<double, 34, 12>::Zero();
